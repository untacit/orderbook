...
public class BookResourceIntTest {
    ...
    public void setup() {
        ...
        final BookResource bookResource = new BookResource(bookRepository, bookMapper);
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pubYear").value(hasItem(DEFAULT_PUB_YEAR.toString())))
    ...
    public void getBook() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books/{id}", book.getId()))
            ...
            .andExpect(jsonPath("$.pubYear").value(DEFAULT_PUB_YEAR.toString()))
